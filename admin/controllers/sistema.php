...
class Sistema
{
    ...
    public function forgot($destinatario, $token)
    {
        if ($this->validateEmail($destinatario)) {
            ...
            $mensaje = "
            Estimado usuario <br>
            <a href=\"http://localhost/constructoraProyectoJJ/admin/login.php?action=recovery&token=$token&correo=$destinatario\">Presione aqui para recuperar la contraseña.</<a> <br>
